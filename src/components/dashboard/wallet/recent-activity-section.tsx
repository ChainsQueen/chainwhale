        ...
        {recentTransactions.slice(0, 15).map((tx, index) => {
          ...
          return (
            <Card
              ...
              className="border border-blue-500/30 bg-gradient-to-r from-blue-500/5 via-slate-500/5 to-blue-500/5 hover:shadow-lg transition-shadow"
            >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-muted-foreground">
                      <span className="lowercase">{isIncoming ? "from" : "to"}</span>
                      <AddressPill address={isIncoming ? fromAddr : toAddr} />
                      <CopyButton
