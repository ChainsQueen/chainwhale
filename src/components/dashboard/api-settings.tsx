      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              id="provider"
              className="w-full transition-shadow border border-blue-500/20 hover:border-blue-500/40"
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {Object.entries(AI_PROVIDERS).map(([key, config]) => (
                <SelectItem
                  key={key}
                  value={key}
                  className="hover:bg-blue-500/10 data-[highlighted]:bg-blue-500/10 data-[state=checked]:from-blue-500/10 data-[state=checked]:via-slate-500/10 data-[state=checked]:to-blue-500/10"
                >
